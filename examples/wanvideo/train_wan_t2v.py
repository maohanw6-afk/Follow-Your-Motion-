...
class LightningModelForDataProcess(pl.LightningModule):
    ...
    def test_step(self, batch, batch_idx):
        ...
        debug_point(
            "train_t2v.data_process.test_step",
            batch_idx=batch_idx,
...
def data_process(args):
    debug_point("train_t2v.entry.data_process", args=vars(args))
...
def train(args):
    debug_point("train_t2v.entry.train", args=vars(args))
